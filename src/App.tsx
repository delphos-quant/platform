...
import About from './views/About'; // Import your About component
import Strategies from './views/Strategies'; // Import your Strategies component
import Analysis from './views/Analysis'; // Import your Analysis component
import Dxlib from './views/Dxlib'; // Import your Dxlib component
import './App.css';
import './markdown.css';
